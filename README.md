# Why do this?
I tried pretty much all the well known image viewers on Linux & did not really like any of them. Viewnior is ok, but it's still too clunky to do quick edits (crop, rotation) & it doesn't work right on Wayland.
